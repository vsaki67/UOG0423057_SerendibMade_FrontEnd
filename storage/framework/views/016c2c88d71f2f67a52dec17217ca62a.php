...
<?php $__env->startSection('title', 'SerendibMade - Artisan'); ?>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="artisan-card bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300">
                    <img src="<?php echo e(asset('Images_used/Artisan_images/img1.png')); ?>" alt="Sri Lankan woman weaving on a handloom"
                ...
                <!-- Artisan 2 -->
                <div class="artisan-card bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300">
                    <img src="<?php echo e(asset('Images_used/Artisan_images/img2.png')); ?>" alt="Artisan carving traditional Sri Lankan wood mask"
                         class="artisan-image w-full h-64 object-cover hover:scale-105">
                    <div class="p-6">
                ...
                <!-- Artisan 3 -->
                <div class="artisan-card bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300">
                    <img src="<?php echo e(asset('Images_used/Artisan_images/img3.png')); ?>" alt="Artist painting traditional Batik fabric"
                         class="artisan-image w-full h-64 object-cover hover:scale-105">
                    <div class="p-6">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="craftsmanship-video bg-gray-300 rounded-lg overflow-hidden shadow-lg">
                    <video controls class="w-full h-auto">
                        <source src="<?php echo e(asset('Images_used/Artisan_images/Srilanka.mp4')); ?>" type="video/mp4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\UOG0423057_FrontEnd\resources\views/artisanpg.blade.php ENDPATH**/ ?>