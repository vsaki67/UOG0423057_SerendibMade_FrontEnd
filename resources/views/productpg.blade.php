            ...
            <div class="mb-16 bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="md:flex">
                    ...
                    <div class="md:w-1/2 p-8 flex flex-col justify-center">
                        ...
                        <div class="mb-6">
                            <span class="text-3xl font-bold text-[#007D7D]">LKR 38,997</span>
                            <span class="text-lg text-gray-500 line-through ml-2">LKR 47,997</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-[#007D7D]">LKR 37,497</span>
                            <button 
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-[#007D7D]">LKR 28,650</span>
                            <button 
                                class="add-to-cart-btn bg-[#007D7D] text-white px-4 py-2 rounded-lg hover:bg-[#006666] transition-colors flex items-center gap-1"
                                data-id="art2"
                                data-name="Kolam Mask"
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-[#007D7D]">LKR 20,397</span>
                            <button 
                                class="add-to-cart-btn bg-[#007D7D] text-white px-4 py-2 rounded-lg hover:bg-[#006666] transition-colors flex items-center gap-1"
                                data-id="art3"
                                data-name="Temple Scene Canvas"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 47,097</span>
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 23,697</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="batik3"
                                data-name="Batik Mens Shirt"
                                data-price="23697"
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 12,897</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="batik4"
                                data-name="Silk Batik Scarf"
                                data-price="12897"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 7,497</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="spice1"
                                data-name="Ceylon Cinnamon"
                                data-price="7497"
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 5,697</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="spice2"
                                data-name="Ceylon Cardamom"
                                data-price="5697"
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 5,097</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="spice3"
                                data-name="Curry Spice Mix"
                                data-price="5097"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 5,997</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="tea1"
                                data-name="Ceylon Earl Grey"
                                data-price="5997"
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 4,797</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="tea2"
                                data-name="Orange Pekoe"
                                data-price="4797"
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 6,897</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="tea3"
                                data-name="Ceylon Green Tea"
                                data-price="6897"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 389,997</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="gem2"
                                data-name="Ceylon Blue Sapphire"
                                data-price="389997"
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 269,997</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="gem3"
                                data-name="Star Ruby"
                                data-price="269997"
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold text-blue-600">LKR 227,097</span>
                            <button class="add-to-cart-btn bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                                data-id="gem4"
                                data-name="Yellow Sapphire"
                                data-price="227097"
