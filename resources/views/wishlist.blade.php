    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div id="wishlist-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @if(isset($wishlistItems) && count($wishlistItems) > 0)
                ...
                <div class="wishlist-item bg-white rounded-2xl shadow hover:shadow-lg transition duration-300 overflow-hidden" data-id="{{ $item['id'] }}">
                    <img src="{{ asset('Images_used/ProductPage_images/' . $item['image']) }}" alt="{{ $item['name'] }}" class="w-full h-48 object-cover">
                    <div class="p-5">
